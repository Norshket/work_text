        ...
        function cropzeeTriggerModal(id, src) {
            ...
            '<div class="light-modal" id="cropzee-modal" role="dialog" aria-labelledby="light-modal-label" aria-hidden="false" data-lightmodal="close">'
                + '<div class="card ' + animation + '">'
                    ...
                    + '</div> -->'
                    + '<!-- light modal body -->'
                    + '<div class="light-modal-body" style="width:48em;">'
                        + '<img id="cropzee-modal-image" src="' + src + '">'
                    + '</div>'
                    + '<!-- light modal footer -->'
                    + '<div class="modal-footer">'
                        + '<div onclick="closeModal()" class="btn btn-danger" style="cursor: pointer;" aria-label="close">Закрыть</div>'
                        + '<div onclick="cropzeeCreateImage(`' + id + '`);" class="btn btn-primary" style="cursor: pointer;">Применить</div>'
                    + '</div>'
                + '</div>'
        ...
        $(this).click(function(){
            ...
            $(this).one("change", function(){
                ...
                if($.inArray(ext, options.allowedInputs) == -1) {
                    ...
                    $('[data-cropzee="' + cropzeeInputId + '"]').replaceWith('<canvas  style="width: 150px;" id="' + previewerId + '" class="' + previewerClass + '" data-cropzee="' + cropzeeInputId + '"></canvas>');
